 ...
 */
function njit_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['njit_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('njit sample setting'),
  '#default_value' => theme_get_setting('njit_example'),
